...
const SubjectCreatePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Navigate back with state to display success notification
      navigate('/subjects', { state: { successMessage: 'Subject created successfully.' } });
    } catch (err) {
    ...
    <div className="page-content">
      <div className="page-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          ...
          <p className="page-subtitle">Create a new subject in the system</p>
        </div>
